...
# ====== 全局可配置参数（可直接在此处修改） ======
USER_NAME = "strongj"         # 用户名
UUID = "afc617b3-5675-47e1-ad11-ec836eb8e073"                     # UUID，留空则自动生成
PORT = 36788                   # Vmess端口，留空或0则自动生成
DOMAIN = "st.linzhi.dpdns.org"                   # 域名，留空则自动获取
CF_TOKEN = "eyJhIjoiNDdmMGJlM2FiY2U0MTM5ZDRlZjAxMjg2OWJmOGVjN2MiLCJ0IjoiNWM1MjQ2NjYtNzVkNC00NDA1LWI3ZmUtZWFmMTczZTdiNmQ3IiwicyI6Ik1tWTJNelEwWlRJdE16ZGxOeTAwTWpsaUxXRXdNRE10WldVeE1UYzRaRFZtWVRGaiJ9"                 # Cloudflare Token，留空则用Quick Tunnel
# =========================================
